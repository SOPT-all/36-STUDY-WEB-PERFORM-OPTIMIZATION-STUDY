...
export const APP_DOWNLOAD = {
  ...
  itemsLeft: [
    {
      id: 'price-alert',
      text: '가격 인하 알림',
      icon: () => <SocialSVG id="ic-graph" width="2.4rem" height="2.4rem" />,
    },
    {
      id: 'secure-payment',
      text: '더 빠르고 안전한 결제',
      icon: () => <SocialSVG id="ic-shield-white" width="2.4rem" height="2.4rem" />,
    },
    {
      id: 'exclusive-benefits',
      text: '독점 혜택',
      icon: () => <SocialSVG id="ic-boon-white" width="2.4rem" height="2.4rem" />,
    },
  ],
  itemsRight: [
    {
      ...
      text: '실시간 주문 추적',
      icon: () => <SocialSVG id="ic-truck-white" width="2.4rem" height="2.4rem" />,
    },
    {
      id: 'stock-alert',
      text: '재고 부족 상품 알림',
      icon: () => <SocialSVG id="ic-hourglass" width="2.4rem" height="2.4rem" />,
    },
    {
      id: 'coupon-alert',
      text: '쿠폰 및 혜택 알림',
      icon: () => <SocialSVG id="ic-coupon" width="2.4rem" height="2.4rem" />,
    },
  ],
  ...
  appStoreLinks: [
    {
      ...
      text: '여기서 다운로드',
      subText: 'App Store',
      icon: () => <SocialSVG id="ic-apple" width="2.4rem" height="2.4rem" />,
    },
    {
      id: 'android',
      text: '여기서 다운로드',
      subText: 'Google Play',
      icon: () => <SocialSVG id="ic-google" />,
    },
  ],
  ...
  socialLinks: {
    ...
    items: [
      {
        id: 'instagram',
        icon: () => <SocialSVG id="ic-instagram" width="2.4rem" height="2.4rem" />,
      },
      { id: 'facebook', icon: () => <SocialSVG id="ic-facebook" width="2.4rem" height="2.4rem" /> },
      { id: 'x', icon: () => <SocialSVG id="ic-footer-x" width="2.4rem" height="2.4rem" /> },
      { id: 'tiktok', icon: () => <SocialSVG id="ic-tiktok" width="2.4rem" height="2.4rem" /> },
      { id: 'youtube', icon: () => <SocialSVG id="ic-youtube" width="2.4rem" height="2.4rem" /> },
      {
        id: 'pinterest',
        icon: () => <SocialSVG id="ic-pinterest" width="2.4rem" height="2.4rem" />,
      },
    ],
  },
};
  ...
  left_info: {
    ...
    content: [
      ...
      { id: 'report', text: '온라인 소매업체 보고서: 2025-공정-0013' },
      {
        ...
        text: '사업자 정보 확인 링크',
        underline: true,
        icon: () => <SocialSVG id="ic-arrow-right-white" width="2.4rem" height="2.4rem" />,
      },
    ],
  },
